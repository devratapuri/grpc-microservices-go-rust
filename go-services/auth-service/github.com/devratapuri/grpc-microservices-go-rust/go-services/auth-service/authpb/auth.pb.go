...
const file_auth_proto_rawDesc = "" +
	...
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseBSZQgithub.com/devratapuri/grpc-microservices-go-rust/go-services/auth-service/authpbb\x06proto3"
